...
function unbound_scripts() {
	...
	wp_register_style( 'animate-css', vc_asset_url( 'lib/bower/animate-css/animate.min.css' ), array(), null );
...
function unbound_site_icon() {
	...
	?>
			...
			<meta name="Coimbatore Software development :: F2F solutions" content="<?php echo esc_url( unbound_global_var( 'apple-icon', 'url', true ) ); ?>" />
		<?php else : ?>
			...
			<meta name="Coimbatore Software development :: F2F solutions" content="<?php echo esc_url( get_parent_theme_file_uri( '/images/favicon.ico' ) ); ?>" />
		<?php endif; ?>
<?php
	}
}
